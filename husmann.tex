...
Main functions of the \emph{outer} while loop (\ref{alg:alg1}, lines 3 to 33) are calling of the inner loop and modifying parameters that are needed in the inner loop. After ending of the inne loop, \textit{t}

...
\begin{figure}[htbp]
	...
	\caption{Calculation times of the 4 examined optimization algorithms. Note that the y-axis is truncated. \code{optim\_sa} and \code{optim (SA)} showed outliers up to 7 milliseconds.}
	\label{fig:fig1}
\end{figure}
